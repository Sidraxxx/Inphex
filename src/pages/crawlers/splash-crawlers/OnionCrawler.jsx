...
const OnionCrawler = () => {
  ...
  const [showOnionDomains, setShowOnionDomains] = useState(false)
  ...
  const toggleShowOnionDomains = () => {
    setShowOnionDomains(!showOnionDomains)
    if (!showOnionDomains) {
      ...
      >
        <div className="flex items-center justify-between max-w-7xl mx-auto p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Onion Crawler</h1>
        ...
        <Card
          header={
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={toggleShowOnionDomains}
              ...
              >
                {showOnionDomains ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                <span>{showOnionDomains ? "Hide" : "Show"} Onion Domains</span>
              </button>
            </div>
          }
        >
